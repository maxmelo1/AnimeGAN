...
def train(epochs=50, anime_data_dir = "dataset/images", bs=128):
    train_images = tf.keras.utils.image_dataset_from_directory(
        anime_data_dir, label_mode=None, image_size=(64, 64), batch_size=bs # Margaret: increase batch size from 32 
    )
    ...
    wgan_gp.fit(train_images, epochs=epochs, callbacks=[GANMonitor(num_img=16, latent_dim=LATENT_DIM)])
